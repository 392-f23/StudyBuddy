...
export const PostItem = ({ post, handleOpenContact, handleOpenAvailability}) => {
    ...
    return (
        <Item className='post-item'>
            ...
            <Chip className='post-course' size="small" label={post.class} />
            ...
            <div className='button-flex'>
                ...
                <Button variant="contained" onClick={handleOpenAvailability}>Availability</Button>
            </div>
        </Item>
    );
}